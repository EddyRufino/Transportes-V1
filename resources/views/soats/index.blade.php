    ...
    <div class="container overflow-auto">
        <div class="content-header">
            <div class="container-fluid">
                  <p class="m-0 text-secondary text-center font-weight-bold mb-3"
                    >
                    Listado de soats

                    <a href="{{ route('soats.excel') }}" data-toggle="tooltip" data-placement="top" title="Descargar en excel" class="text-primary ml-1">
