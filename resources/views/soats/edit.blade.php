...
@section('content')
    <div class="container">
        <form action="{{ route('soats.update', $soat->id) }}" method="post" enctype="multipart/form-data">
            {{ csrf_field() }} {{ method_field('PUT') }}
            <h2 class="text-center read text-secondary mt-3">Editar Soats</h2><br>
        <div class="row">
            <div class="col-sm-6">
                ...
                <div class="form-group mt-4">
                    ...
                    <input class="form-control col-md-8 bg-light shadow-sm "
                            ...
                            value="{{ old('num_poliza', $soat->num_poliza) }}">
                    </div>
                        ...
                        <div class="form-group text-center mt-4">
                            <div class="form-group d-flex justify-content-center align-items-center">
                                ...
                                <input class="form-control col-md-8 bg-light shadow-sm  datepicker"
                                        ...
                                        value="{{ old('inicio_poliza', $soat->inicio_poliza) }}">
                        ...
                        <div class="form-group text-center">
                            <div class="form-group d-flex justify-content-center align-items-center">
                                ...
                                <input class="form-control col-md-8 bg-light shadow-sm  datepicker"
                                        ...
                                        id="datepickers2"
                                        placeholder="Ingresa la fecha..."
                                        value="{{ old('fin_poliza', $soat->fin_poliza) }}">
                        ...
                        <div class="form-group text-center mt-4">
                            <div class="form-group d-flex justify-content-center align-items-center">
                                ...
                                <input class="form-control col-md-8 bg-light shadow-sm  datepicker"
                                        ...
                                        id="datepickers3"
                                        placeholder="Ingresa la fecha..."
                                        value="{{ old('inicio_certificado', $soat->inicio_certificado) }}">
                        ...
                        <div class="form-group text-center">
                            <div class="form-group d-flex justify-content-center align-items-center">
                                ...
                                <input class="form-control col-md-8 bg-light shadow-sm  datepicker"
                                        ...
                                        id="datepickers4"
                                        placeholder="Ingresa la fecha..."
                                        value="{{ old('fin_certificado', $soat->fin_certificado) }}">
                    ...
                    <div class="d-flex justify-content-center align-items-center">
                        <select class="form-control select2 col-md-8 " name="dato_id">
                            @foreach ($datos as $dato)
                                <option class="" value="{{ $dato->id }}"
                                    {{ old('dato_id', $soat->dato_id) == $dato->id ? 'selected' : '' }}
                                    >{{ $dato->nombre }}
                                </option>
                            @endforeach
                ...
                <div class="form-group">
                    ...
                    <input class="form-control col-md-8 bg-light shadow-sm "
                            ...
                            value="{{ old('telefono', $soat->telefono) }}">
                    </div>
                ...
                <h5 class="lead text-secondary mover">Datos del vehículo</h5 class="lead">
                    <div class="form-group mt-4 pt-4">
                        ...
                        <input class="form-control col-md-8 bg-light shadow-sm "
                                ...
                                value="{{ old('uso_vehiculo', $soat->uso_vehiculo) }}">
                        </div>
                        ...
                        {{-- <div class="col-md-4"> --}}
                            <div class="form-group mt-4">
                                ...
                                <input class="form-control col-md-8 bg-light shadow-sm  datepicker"
                                        ...
                                        value="{{ old('fecha_hoy', $soat->fecha_hoy) }}">
                                </div>
                        ...
                        {{-- <div class="col-md-4"> --}}
                            <div class="form-group mt-4">
                                ...
                                <input class="form-control col-md-8 bg-light shadow-sm "
                                        ...
                                        value="{{ old('hora_emision', $soat->hora_emision) }}">
                                </div>
                        ...
                        {{-- <div class="col-md-4"> --}}
                            <div class="form-group mt-4">
                                ...
                                <input class="form-control col-md-8 bg-light shadow-sm "
                                        ...
                                        value="{{ old('monto_prima', $soat->monto_prima) }}">
                                </div>
                                    ...
                                    <select class="form-control select2 col-md-8 " name="vehiculo_id">
                                        @foreach ($vehiculos as $vehiculo)
                                            <option value="{{ $vehiculo->id }}"
                                                {{ old('dato_id', $soat->vehiculo_id) == $vehiculo->id ? 'selected' : '' }}
                                                >
                                                {{ $vehiculo->placa }}
                                            </option>
                                        @endforeach
