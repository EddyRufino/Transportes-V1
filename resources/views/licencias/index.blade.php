    ...
    <div class="content-header">
      <div class="container-fluid">
        ...
        >
          ...
          <a href="{{ route('licencias.excel') }}" data-toggle="tooltip" data-placement="top" title="Descargar en excel" class="text-primary ml-1">
        ...
        <div class="row mb-2">
          <div class="col-sm-4">
            <a class="btn btn-primary inline-block " href="{{ route('licencias.create') }}">Nueva Licencia</a>
          </div><!-- /.col -->
          <div class="col-sm-4">
    ...
    <table class="table">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    <a href="{{ route('licencias.show', $licencia->id) }}" data-toggle="tooltip" data-placement="top" title="Ver más" class="text-success mr-2">
                    ...
                    <a href="{{ route('licencias.edit', $licencia->id) }}" data-toggle="tooltip" data-placement="top" title="Editar" class="text-warning mr-2">
                        <svg width=".9em" height="1em" viewBox="0 0 16 16" class="bi bi-pencil-square" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                          ...
                          @auth
                            ...
                            <form method="POST" action="{{ route('licencias.destroy', $licencia) }}"
                                    ...
                                    {{-- <a href="#" 
                                        onclick="return confirm('Estás seguro de querer eliminar esta licencia?')" data-toggle="tooltip" data-placement="top" title="Eliminar" class="text-danger ">
                    ...
                    {{-- <ul style="list-style: none">
                        <li class="nav-item dropdown">
                            ...
                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                            <a class="btn btn-success" href="{{ route('licencias.edit', $licencia->id) }}">Editar</a>
