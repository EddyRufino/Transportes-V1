...
<div class="container overflow-auto">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <p class="m-0 font-weight-bold text-secondary text-center mb-3">Listado de Integrantes</p>
        <div class="row mb-2">
          <div class="col-sm-4">
                        ...
                        <svg width=".9em" height="1em" viewBox="0 0 16 16" class="bi bi-pencil-square" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                          ...
                          @auth
                            ...
                            <form method="POST" action="{{ route('datos.destroy', $dato) }}"
                                    ...
                                    <a href="#" 
                                        onclick="return confirm('Estás seguro de querer eliminar este integrante?')" data-toggle="tooltip" data-placement="top" title="Eliminar" class="text-danger ">
