...
@section('content')
    ...
    <div class="container">
        <form action="{{ route('paraderos.update', $paradero->id) }}" method="post" enctype="multipart/form-data">
            {{ csrf_field() }} {{ method_field('PUT') }}

            <h2 class="text-center font-weight-bold lead text-secondary">Ingresar Datos Paradero</h2>
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input class="form-control col-md-8 bg-light shadow-sm border-0"
                                ...
                                value="{{ old('fecha_expedicion', $paradero->fecha_expedicion) }}">
                        </div>
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input class="form-control col-md-8 bg-light shadow-sm border-0"
                                ...
                                value="{{ old('num_operacion', $paradero->num_operacion) }}">
                        </div>
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input class="form-control col-md-8 bg-light shadow-sm border-0"
                                ...
                                value="{{ old('fecha_caducidad', $paradero->fecha_caducidad) }}">
                        </div>
                ...
                <div class="col-sm-6">
                    <div class="form-group">
                        ...
                        <input class="form-control col-md-8 bg-light shadow-sm border-0"
                                ...
                                value="{{ old('presidente', $paradero->presidente) }}">
                        </div>
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control col-md-8 bg-light shadow-sm border-0"
                                ...
                                value="{{ old('vicepresidente', $paradero->vicepresidente) }}">
                        </div>
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control col-md-8 bg-light shadow-sm border-0"
                                ...
                                value="{{ old('secretario', $paradero->secretario) }}">
                        </div>
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control col-md-8 bg-light shadow-sm border-0"
                                ...
                                value="{{ old('tesorero', $paradero->tesorero) }}">
                        </div>
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control col-md-8 bg-light shadow-sm border-0"
                                ...
                                value="{{ old('inicio_vigencia', $paradero->inicio_vigencia) }}">
                        </div>
                ...
                <div class="col-sm-6">
                    <div class="form-group">
                        ...
                        <input class="form-control col-md-8 bg-light shadow-sm border-0"
                                ...
                                type="number"
                                value="{{ old('dni_presidente', $paradero->dni_presidente) }}">
                        </div>
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control col-md-8 bg-light shadow-sm border-0"
                                ...
                                type="number"
                                value="{{ old('dni_vice_presidente', $paradero->dni_vice_presidente) }}">
                        </div>
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control col-md-8 bg-light shadow-sm border-0"
                                ...
                                type="number"
                                value="{{ old('dni_secretario', $paradero->dni_secretario) }}">
                        </div>
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control col-md-8 bg-light shadow-sm border-0"
                                ...
                                type="number"
                                value="{{ old('dni_tesorero', $paradero->dni_tesorero) }}">
                        </div>
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control col-md-8 bg-light shadow-sm border-0"
                                ...
                                value="{{ old('fin_vigencia', $paradero->fin_vigencia) }}">
                        </div>
            ...
            <div class="form-group">
            	<div class="d-flex justify-content-center align-items-center">
                    <button class="col-md-8 btn btn-primary btn-block">Actualizar</button>
                    <div></div>
                </div>
            </div>
